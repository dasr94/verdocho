                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-print-none">
                                        <div class="float-right">
                                            ...
                                            <button onclick="cambiarEstado('Completado', '<?php echo $numero_orden ?>')"  class="btn btn-primary w-md waves-effect waves-light">Completar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function cambiarEstado(estado, orden){
            ...
            $.ajax({
                url: 'php/action.php',
                method: 'POST',
                data: {"est" : estado, "num_orden" : orden, "opt" : "cambiar-estado2"},
                beforeSend: function(){

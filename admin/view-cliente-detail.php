...
$id = $_REQUEST['id'];
$clientes = $dTask->mostrarClienteUnico($id);
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="frm-cliente">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input name="nombre" class="form-control" type="text" id="nombre" value="<?php echo $clientes[0]['nombre'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="direccion" class="col-md-3 col-form-label">Dirección</label>
                                            <div class="col-md-9">
                                                <input name="direccion" class="form-control" type="text" id="direccion" value="<?php echo $clientes[0]['direccion'] ?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control col-md-9 select2-departamentos" name="departamento">
                                                <option value="<?php echo $clientes[0]['departamento'] ?>"> <?php echo $clientes[0]['departamento'] ?> </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control col-md-9 select2-municipios" name="municipio">
                                                <option value="<?php echo $clientes[0]['municipio'] ?>"> <?php echo $clientes[0]['municipio'] ?> </option>
                                                <option value="AHUACHAPÁN">AHUACHAPÁN</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input name="telefono" class="form-control" type="text" id="telefono" value="<?php echo $clientes[0]['telefono'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="mail" class="col-md-3 col-form-label">Correo electronico</label>
                                            <div class="col-md-9">
                                                <input name="mail" class="form-control" type="email" id="mail" value="<?php echo $clientes[0]['correo'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="mail" class="col-md-3 col-form-label">DUI</label>
                                            <div class="col-md-9">
                                                <input name="dui" class="form-control" type="text" id="mail" value="<?php echo $clientes[0]['dui'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        <label class="col-md-3 control-label">Categoria</label>
                                            <select class="form-control col-md-9" name="categoria">
                                                ...
                                                <option value="<?php echo $clientes[0]['categoria'] ?>"><?php echo $clientes[0]['categoria'] ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input name="birthday" class="form-control" type="date"  id="example-date-input" value="<?php echo $clientes[0]['fecha_nac'] ?>">
                                            </div>
                                        </div>

                                        <input type="hidden" name="opt" value="update-cliente">

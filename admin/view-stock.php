                ...
                <div class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="dashboard-bodega.php" class=" waves-effect">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18 font-lemon">Ver stock</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active" style="color: white;">Acá puedes ver todos los productos</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="datatable">
                                            ...
                                            foreach($productos as $pe){
                                                ...
                                                echo "<td> <input type='text' value='" . $pe['cantidad'] . "' class='form-control' id='cantidad-".$i."'  </td>";
                                                echo "<td> <button class='btn btn-danger' onclick='eliminarProducto(\" ".$pe['stock_id']."\");'><i class='mdi mdi-trash-can-outline'></i></button> <button class='btn btn-info' onclick='actualizarProducto(\"".$pe['stock_id']."\", $(\"#cantidad-".$i."\").val())' ><i class='mdi mdi-file-document-edit-outline'></i></button>  </td>";
                                                echo "</tr>";
                                                $i++;
                                            }

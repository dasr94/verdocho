...
$usuarios = $dTask->mostrarUsuarios();
?> 
<!doctype html>
<html lang="en">
...
<body data-layout="detached" data-topbar="colored">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18 font-lemon">Ver Usuarios</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active" style="color: white;">Acá puedes ver todos los usuarios</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="datatable">
                                            ...
                                            foreach($usuarios as $pe){
                                                ...
                                                echo "<tr>";
                                                echo "<td>" . $pe['usuario'] . "</td>";
                                                echo "<td>" . $pe['contra'] . "</td>";
                                                echo "<td>" . $pe['nombre'] . "</td>";
                                                echo "<td>" . $pe['correo'] . "</td>";
                                                echo "<td>" . $nivel . "</td>";
                                                echo "<td> <button class='btn btn-danger' onclick='eliminarUsuario(\" ".$pe['id']."\");'><i class='mdi mdi-trash-can-outline'></i></button> <a class='btn btn-info' href='view-user-detail.php?id=".$pe['id']."'><i class='mdi mdi-eye-outline'></i></a>  </td>";
                                                echo "</tr>";
                                                $i++;
                                            }
    ...
    <script>
        ...
        function eliminarUsuario(idpro){
            console.info("Eliminando producto...");
            $.ajax({
                url: 'php/action.php',
                data: { "opt" : "eliminar-usuario", "idp" : idpro },
                method: "POST",
                beforeSend: function(){
        ...
        function actualizarProducto(idpro, cant){
            console.info("Actualizando producto...");
            $.ajax({
                url: 'php/action.php',
                data: { "opt" : "actualizar-producto", "idp" : idpro, "canti" : cant },
                method: "POST",
                beforeSend: function(){

                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18 font-lemon">Crear usuario</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active" style="color: white;">Puedes agregar un usuario</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="frm-user">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input name="usuario" class="form-control" type="text" id="usuario">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="contra" class="col-md-2 col-form-label">Contraseña</label>
                                            <div class="col-md-10">
                                                <input name="contra" class="form-control" type="text" id="contra" minlength="6" maxlength="12">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input name="correo" class="form-control" type="email" id="correo">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <input type="hidden" name="opt" value="create-user">

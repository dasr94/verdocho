...
$pedidos = $dTask->mostrarPedidosEstado("Ingreso");
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="dashboard-bodega-2.php">Detalle de Pedidos</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                                            ...
                                            <tbody>
                                                <?php
                                                    foreach ($pedidos as $pe) {
                                                        ...
                                                        echo "<td>" . $f1 . "</td>";
                                                        echo "<td> <a class='btn btn-primary' href='view-order-bodega.php?orden=" . $pe['codigo_pedido'] . "' > Gestionar </a>";
                                                    }
                                                ?>
                                            </tbody>
                                        </table>

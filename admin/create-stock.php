...
$categorias = $dTask->mostrarCategorias();
?>
<!doctype html>
<html lang="en">
...
<head>
    <meta charset="utf-8" />
    <title>Crear producto | VERDOCHO</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18 font-lemon">Crear producto</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active" style="color: white;">Puedes agregar un producto</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-title-desc">Ingresa los datos del producto</p>

                                    <form method="POST" id="frm-stock">

                                        <div class="form-group row">
                                            <label for="producto" class="col-md-2 col-form-label">Producto</label>
                                            <div class="col-md-10">
                                                <input name="producto" class="form-control" type="text" id="producto">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="contra" class="col-md-2 col-form-label">Costo</label>
                                            <div class="col-md-10">
                                                <input name="costo" class="form-control" type="number" id="contra" step="0.01" min="0" max="100">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="nombre" class="col-md-2 col-form-label">Venta</label>
                                            <div class="col-md-10">
                                                <input name="venta" class="form-control" type="number" id="nombre" step="0.01" min="0" max="100">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="correo" class="col-md-2 col-form-label">Cantidad</label>
                                            <div class="col-md-10">
                                                <input name="cantidad" class="form-control" type="number" id="correo">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <select name="categoria" class="form-control">
                                                    ...
                                                    foreach ($categorias as $key) {
                                                        echo '<option value="'.$key['id_cat'].'">'.$key['Categoria'].'</option>';
                                                    }
                                        ...
                                        <input type="hidden" name="opt" value="create-stock">
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            Swal.fire(
                                ...
                                'Ya puedes cargar al carrito',
                                'success'
                            )
                            $("#frm-stock").trigger("reset");
                        } else {
                            Swal.fire(
                                '¡Algo ocurrio!',
                                'Intenta de nuevo...',

...
$clientes = $dTask->mostrarClientes();
?> 
<!doctype html>
<html lang="en">
...
<body data-layout="detached" data-topbar="colored">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="page-title mb-0 font-size-18 font-lemon">Ver Clientes</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item active" style="color: white;">Acá puedes ver todos los clientes</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="datatable">
                                            ...
                                            foreach($clientes as $pe){
                                                ...
                                                echo "<td>" . $pe['telefono'] . "</td>";
                                                echo "<td>" . $pe['correo'] . "</td>";
                                                echo "<td>" . $badge . "</td>";
                                                echo "<td> <button class='btn btn-danger' onclick='eliminarCliente(\" ".$pe['idcliente']."\");'><i class='mdi mdi-trash-can-outline'></i></button> <a class='btn btn-info' href='view-cliente-detail.php?id=".$pe['idcliente']."'><i class='mdi mdi-eye-outline'></i></a>  </td>";
                                                echo "</tr>";
                                                $i++;
                                            }
    ...
    <script>
        ...
        function eliminarCliente(idpro){
            console.info("Eliminando producto...");
            $.ajax({
                url: 'php/action.php',
                data: { "opt" : "eliminar-cliente", "idp" : idpro },
                method: "POST",
                beforeSend: function(){

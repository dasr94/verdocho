...
<body data-layout="detached" data-topbar="colored">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="datatable">
                                            ...
                                            foreach($pedidos as $pe){
                                                ...
                                                switch ($pe['estado']){
                                                    case 'Ingreso':
                                                        $estado_color = "badge-soft-info";
                                                        break;
                                                    case 'Preparo':
                                                        $estado_color = "badge-soft-warning";
                                                        break;
                                                    case 'Envio':
                                                        $estado_color = "badge-soft-warning";
                                                        break;
                                                    case 'Completado':
                                                        $estado_color = "badge-soft-success";
                                                        break;
                                                    default:
                                                        $estado_color = "badge-soft-danger";
                                                        break;
                                                }
                                                echo "<tr>";
                                                echo "<td>" . $pe['codigo_pedido'] . "</td>";
                                                echo "<td>" . substr($pe['nombre'], 0, strpos($pe['nombre'], ' ', 1))  . "</td>";
                                                echo "<td>" . $d->format('d-M H:i') . "</td>";
                                                echo "<td>$" . $pe['monto'] . "</td>";
                                                echo "<td>" . $nombre_tipo_pago . "</td>";
                                                echo "<td> <span class='badge ". $estado_color ." font-size-12'>" . $pe['estado'] . "</span>  </td>";
                                                echo "<td> <button class='btn btn-danger' onclick='eliminarPedido(\" ".$pe['codigo_pedido']."\", \" ".$pe['idpedido']."\");'><i class='mdi mdi-trash-can-outline'></i></button> <a class='btn btn-info' href='order-state-details.php?orden=".$pe['codigo_pedido']."'><i class='mdi mdi-eye-outline'></i></a>  </td>";
                                                echo "</tr>";
                                            }
    ...
    <script>
        ...
        function eliminarPedido(num_orden, idped){
            console.info("Eliminando producto...");
            $.ajax({
                url: 'php/action.php',
                data: { "n_orden" : num_orden, "opt" : "eliminar-pedido", "idp" : idped },
                method: "POST",
                beforeSend: function(){
